...
namespace AssetStudioGUI
{
    public partial class UnityCNForm : Form
    {
        public UnityCNForm()
        {
            ...
            var keys = UnityCNKeyManager.GetEntries();
        ...
        private void specifyUnityCNList_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            UnityCNKeyManager.SaveEntries(keys.Reverse<UnityCN.Entry>().ToList());
            UnityCNKeyManager.SetKey(specifyUnityCNList.CurrentRow.Index);
